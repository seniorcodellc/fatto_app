import 'package:fatto/features/auth/forgot_password/screens/forgot_password1_screen.dart';
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              SizedBox(height: 50),
              SignupText(title: 'Login', subTitle: 'Don\'t have an account?' , coloredText: 'Signup',),
              SizedBox(height: 18),
              ...
              Padding(
                ...
                child:Text('Forgot password?',style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w500,fontSize: 14,color: AppColors.primaryColor),)),
              ),
