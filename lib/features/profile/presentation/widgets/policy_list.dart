    ...
    return Padding(
      ...
      child: Column(
        children: List.generate(
          PolicyTermsConditionsStatic.policyList.length - 1,
          (index) {
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    PolicyTermsConditionsStatic.policyList[index].title!,
                    style: AppStyles.font14Black,
                  ),
                  SizedBox(height: 8),
                  Text(
                    PolicyTermsConditionsStatic.policyList[index].description!,
